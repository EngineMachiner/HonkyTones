...
class Advancements( generator: FabricDataGenerator ) : FabricAdvancementsProvider(generator) {
    ...
    private companion object {
        ...
        fun addInstruments( list: List< KClass<*> >, consumer: Consumer<Advancement> ) {
        ...
        interface RecipeCriterion : ModID {
            ...
            fun genericConditions(): AbstractCriterionConditions {
        ...
        object Doot : ModAdvancement() {
            ...
            override fun conditions(): AbstractCriterionConditions {
                ...
                val predicate = ItemPredicate.Builder.create().items(icon).build()
        ...
        object Keyboard : ModAdvancement(), RecipeCriterion {
            ...
            override fun conditions(): AbstractCriterionConditions { return genericConditions() }
        ...
        class Instrument( kClass: KClass<*>, override val parent: ModAdvancement ) : ModAdvancement() {
            ...
            override fun title(): Text { return LiteralText(title) }
