...
class DigitalConsoleScreenHandler(
    ...
    companion object : ModID {
        ...
        val type: ScreenHandlerType<DigitalConsoleScreenHandler> = ScreenHandlerRegistry.registerSimple( classID(), ::DigitalConsoleScreenHandler )
...
class DigitalConsoleScreen(
    ...
    override fun onClose() {
        ...
        if ( recordCheckbox!!.isChecked ) stopRecording();  super.onClose()
    ...
    override fun tick() { recordingMenu();        recordTick();     super.tick() }
    ...
    private fun recordingMenu() {
        ...
        client!!.openScreen( RecordingScreen(this) )
...
class PickStackScreenHandler( syncID: Int, playerInventory: PlayerInventory ) : ScreenHandler( type, syncID ) {
    ...
    companion object : ModID {
        ...
        val type: ScreenHandlerType<PickStackScreenHandler> = ScreenHandlerRegistry.registerSimple( classID(), ::PickStackScreenHandler )
...
class PickStackScreen(
    ...
    companion object {
        ...
        fun register() { ScreenRegistry.register( PickStackScreenHandler.type, ::PickStackScreen ) }
