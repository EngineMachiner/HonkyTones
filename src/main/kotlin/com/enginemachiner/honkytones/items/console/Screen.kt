...
import net.minecraft.resource.featuretoggle.FeatureFlags.VANILLA_FEATURES
...
class DigitalConsoleScreenHandler(
    ...
    override fun onClosed( player: PlayerEntity ) {
        ...
        super.onClosed(player);        val stack = instrument()
    ...
    companion object : ModID {
        ...
        val type = ScreenHandlerType( ::DigitalConsoleScreenHandler, VANILLA_FEATURES )
...
class PickStackScreenHandler( syncID: Int, playerInventory: PlayerInventory ) : HarmonyScreenHandler( type, syncID ) {
    ...
    companion object : ModID {
        ...
        val type = ScreenHandlerType( ::PickStackScreenHandler, VANILLA_FEATURES )
