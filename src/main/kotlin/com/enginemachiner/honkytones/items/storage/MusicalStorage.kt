    ...
    companion object {
        ...
        fun registerRender() {
            ...
            fun onThirdPerson(matrix: MatrixStack) {
                ...
                matrix.multiply( Quaternion.method_35825(0.75f, 0.0f, 0f) )
            }

            fun onGUI(matrix: MatrixStack) {
                matrix.translate(0.075, 0.23, 0.0)
                matrix.scale( 0.625f, 0.625f, 0.625f )
                matrix.multiply( Quaternion.method_35825(0.55f, 0.8f, 0f) )
            }

            fun onGround(matrix: MatrixStack) {
                matrix.translate(0.25, 0.25, 0.25)
                matrix.scale( 0.5f, 0.5f, 0.5f )
                matrix.multiply( Quaternion.method_35825(0.0f, 0.0f, 0.0f) )
            }
