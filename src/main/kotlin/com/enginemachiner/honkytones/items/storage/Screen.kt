...
class StorageScreenHandler(
    ...
    private val stack = player.itemsHand.find { it.item is MusicalStorage }!!
    ...
    companion object : ModID {
        ...
        val type: ScreenHandlerType<StorageScreenHandler> = ScreenHandlerRegistry.registerSimple( classID(), ::StorageScreenHandler )
...
class StorageScreen(
    ...
    companion object {
        ...
        fun register() { ScreenRegistry.register( StorageScreenHandler.type, ::StorageScreen ) }
