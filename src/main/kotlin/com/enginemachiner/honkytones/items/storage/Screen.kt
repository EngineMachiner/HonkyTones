...
class StorageScreen(
    ...
    override fun drawBackground( context: DrawContext, delta: Float, mouseX: Int, mouseY: Int ) {
        ...
        // Bottom border.
        context.drawTexture( texture, x, centerY + h, 43, backgroundHeight - 7, w - 3, 3 )
        ...
        // Player inventory.
        h = 96
        context.drawTexture( texture, centerX, centerY + rows * 18 + 17, 0, 126, w, h )
        ...
        x = centerX + spaceX + padX
        context.drawTexture( texture, x, centerY, 43, 0, w - 43, h )
