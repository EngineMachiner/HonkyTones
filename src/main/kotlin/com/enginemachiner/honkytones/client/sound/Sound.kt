...
open class FadingSound( open val path: String ) : MovingSoundInstance( soundEvent(path), category ) {
    ...
    companion object {
        ...
        private fun soundEvent(path: String): SoundEvent { val id = modID(path);    return SoundEvent(id) }
