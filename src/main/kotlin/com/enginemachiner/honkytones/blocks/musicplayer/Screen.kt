...
class MusicPlayerScreen(
    ...
    override fun drawBackground( context: DrawContext, delta: Float, mouseX: Int, mouseY: Int ) {
        ...
        // Top slots.
        context.drawTexture( genericTexture, centerX - 62, centerY + 5, 0, 0, w, 35 )
        context.drawTexture( genericTexture, centerX + 71, centerY + 5, 7, 0, w - 7, 35 )

        // Blank space.
        context.drawTexture( genericTexture, centerX - 62, centerY + 40, 0, 4, w, 13 )
        context.drawTexture( genericTexture, centerX + 71, centerY + 40, 7, 4, w - 7, 13 )

        context.drawTexture( genericTexture, centerX - 62, centerY + 52, 0, 4, w, 13 )
        context.drawTexture( genericTexture, centerX + 71, centerY + 52, 7, 4, w - 7, 13 )
        context.drawTexture( genericTexture, centerX, centerY + 64, 0, 4, w, 2 )

        // Upper part texture.
        context.drawTexture( genericTexture, centerX - 62, centerY + 64, 0, backgroundHeight + 53, w - 113, 3 )
        context.drawTexture( genericTexture, centerX + 173, centerY + 64, 109, backgroundHeight + 53, w - 113, 3 )

        // Floppy disk slot.
        context.drawTexture( genericTexture, centerX + 215, centerY + 44, 7, 17, 18, 18 )

        // Player inventory.
        context.drawTexture( genericTexture, centerX, centerY + 66, 0, 126, w, 128 )
