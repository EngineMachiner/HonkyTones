...
open class FadingSound( val path: String ) : MovingSoundInstance(
    SoundEvent.of( modID(path) ), SoundCategory.PLAYERS, SoundInstance.createRandom()
) {
...
object Sound {
    ...
    fun modSound(path: String): SoundEvent? { return Registries.SOUND_EVENT.get( modID(path) ) }
